...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _helpers_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/index.js */ \"./assets/js/helpers/index.js\");\n// menu.js\n\nconst hamburger = document.getElementById('hamburger');\nconst nav = document.getElementById('nav'); // Toggle aria-expanded attribute\n\nhamburger.addEventListener('click', e => {\n  // Get the aria-expanded attribute and check if the value is \"false\"\n  const isOpen = hamburger.getAttribute('aria-expanded') === \"false\"; // Change the aria-expanded value accordingly\n\n  hamburger.setAttribute('aria-expanded', isOpen); // toggle nav\n\n  if (isOpen) {\n    nav.style.display = \"block\"; // trap focus in nav\n\n    (0,_helpers_index_js__WEBPACK_IMPORTED_MODULE_0__.trapFocus)(nav);\n  } else {\n    nav.style.display = \"none\";\n  }\n}); // Hide nav on keydown Escape\n\nnav.addEventListener('keyup', e => {\n  if (e.code === 'Escape') {\n    nav.style.display = \"none\";\n    hamburger.setAttribute('aria-expanded', false);\n  }\n});\n\n//# sourceURL=webpack://blank/./assets/js/components/menu.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _helpers_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/index.js */ \"./assets/js/helpers/index.js\");\n// modal.js\n // constants\n\nconst wrapper = document.getElementById('wrapper');\nconst modal = document.getElementById('modal');\nconst closeModalButton = document.getElementById('close-modal');\nconst modalTitle = document.getElementById('modal-title'); // variables\n\nlet openModalButtons = document.getElementsByClassName(\"open-modal\");\nlet modalTrigger; // open modal\n\nfunction openModal(button) {\n  // set trigger to focus on when closing the modal\n  modalTrigger = button.target; // make wrapper hidden\n\n  wrapper.setAttribute('aria-hidden', 'true');\n  wrapper.setAttribute('tab-index', '-1'); // show modal\n\n  modal.style.display = \"flex\";\n  modal.setAttribute('tab-index', '0');\n  modal.setAttribute('aria-hidden', 'false'); // trap focus in modal\n\n  (0,_helpers_index_js__WEBPACK_IMPORTED_MODULE_0__.trapFocus)(modal);\n} // close modal\n\n\nfunction closeModal() {\n  // hide modal\n  modal.style.display = \"none\";\n  modal.setAttribute('tab-index', '-1');\n  modal.setAttribute('aria-hidden', 'true'); // make wrapper visible and focusable\n\n  wrapper.setAttribute('aria-hidden', 'false');\n  wrapper.setAttribute('tab-index', '0'); // set focus to modal trigger (button)\n\n  modalTrigger.focus();\n} // open modal button event listeners\n\n\nfor (var i = 0; i < openModalButtons.length; i++) {\n  openModalButtons[i].addEventListener('click', openModal, true);\n} // close modal button event listener\n\n\ncloseModalButton.onclick = function () {\n  closeModal();\n};\n\n//# sourceURL=webpack://blank/./assets/js/components/modal.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _js_lib_gsap_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../js/lib/gsap/gsap.min.js */ \"./assets/js/lib/gsap/gsap.min.js\");\n/* harmony import */ var _js_lib_gsap_gsap_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_js_lib_gsap_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _js_components_menu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../js/components/menu.js */ \"./assets/js/components/menu.js\");\n/* harmony import */ var _js_components_modal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../js/components/modal.js */ \"./assets/js/components/modal.js\");\n// libraries\n // components\n\n\n // gsap\n\ngsap.registerPlugin('ScrollTrigger');\ngsap.config({\n  nullTargetWarn: true\n});\n\n//# sourceURL=webpack://blank/./assets/js/main.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./sass/styles.scss");
/******/ 	
/******/ })()
;